...
let tuanActiveId = `U_UWONEcWPrMkHEWZE2A-w==`;
...
url签名参数
 */
const random = 'H/m6vXp0Kvq0';
let token = `tk01w8cc71b00a8nOFF0d0EwbW9LABxiVEWfomX9VjmeglhrPC988BTWONX172I07LxyxcXBCd0Ua0wJZ1mEEq4a1hX/`;
let fingerprint = 5053869062884161;
const appId = 10001;

let fingerprintJD = '5053869062884161';
let urlSignTokenJD = 'tk01w8cc71b00a8nOFF0d0EwbW9LABxiVEWfomX9VjmeglhrPC988BTWONX172I07LxyxcXBCd0Ua0wJZ1mEEq4a1hX/';
let enCryptMethodJD = function test(token,fingerprint,timestamp,appId,algo){const random=`H/m6vXp0Kvq0`;const str=`${token}${fingerprint}${timestamp}${appId}${random}`;return algo.HmacSHA256(str,token)};
