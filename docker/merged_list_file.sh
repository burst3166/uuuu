...
35 7,12,23 * * * sleep $((RANDOM % $RANDOM_DELAY_MAX)); node /scripts/jd_global_mh.js |ts >> /scripts/logs/jd_global_mh.log 2>&1
#环球挑战赛 第二季(活动时间：2021-03-08 至 2021-03-31)
5 6,22 * * * sleep $((RANDOM % $RANDOM_DELAY_MAX)); node /scripts/jd_global.js |ts >> /scripts/logs/jd_global.log 2>&1
